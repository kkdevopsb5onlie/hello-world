        ...
        stage ('deploying into eks') {
            steps {
                script {
                    ...
                    withCredentials([[$class: 'AmazonWebServicesCredentilasBinding', credentialsId: 'eks-credentils', acccessKeyVariable:  'AWS_ACCESS_KEY_ID', secretKeyVariable: 'AWS_SECRET_ACCESS_KEY']]) {
